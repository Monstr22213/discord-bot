...
async def publish_rules(interaction: discord.Interaction, канал: discord.TextChannel = None):
    ...
    # Правила (20 шт) - современно с эмодзи
    rules = (
        ...
        "4️⃣ 🎙️ **В войсе микро настрой.** Если ты хрипишь как дед после 40 лет курения - включи шумодав или сиди в муте 🔇\n\n"
    ...
    # QR код отдельным embed с картинкой
